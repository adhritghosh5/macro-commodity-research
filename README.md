...
cd macro-commodity-research

# Install dependencies
pip install numpy pandas matplotlib seaborn statsmodels yfinance
```

### 3. Running Analysis & Signal Engine
```bash
# Execute the commodity scarcity multi-layer scoring model
python src/signal_engine.py

# Run backtests for policy-driven equity allocation
python backtests/policy_momentum_backtest.py
```
...
```bibtex
@techreport{ghosh2025crude,
  author = {Ghosh, Adhrit},
  title = {Crude Oil & Indian Equities: Report on the Price Action of Crude Oil},
  institution = {Macro & Commodity Research Group},
  year = {2025},
  month = {September}
}

@techreport{ghosh2026darkgold,
  author = {Ghosh, Adhrit},
  title = {From Dark Gold to Digital Gold: The Commodities Behind the AI–Energy Transition},
  institution = {Macro & Commodity Research Group},
  year = {2026},
  month = {September}
}

@techreport{ghosh2025modipolicies,
  author = {Ghosh, Adhrit},
  title = {Impact on the Market due to Modi-Era Government Policies (2014–2025)},
  institution = {Macro & Commodity Research Group},
  year = {2025},
  month = {September}
}
